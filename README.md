...
[English](#english) · [功能特性](#功能特性) · [快速开始](#快速开始) · [下载安装](#下载安装)

</div>

## 功能特性

- **SSH 终端** — 基于 xterm.js，xterm-256color PTY，实时 I/O，窗口自适应
- **SFTP 文件管理** — 浏览、上传、下载、删除、新建文件夹，默认打开用户 home 目录
